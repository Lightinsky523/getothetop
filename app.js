...
// limit:false 表示 raw-body 不做大小限制（但仍可能受上游网关/超时/内存影响）
const BODY_LIMIT_RAW = process.env.BODY_LIMIT;
const BODY_LIMIT = !BODY_LIMIT_RAW || BODY_LIMIT_RAW === 'unlimited' ? false : BODY_LIMIT_RAW;
app.use(express.json({ limit: BODY_LIMIT }));
app.use(express.urlencoded({ limit: BODY_LIMIT, extended: true }));
console.log('[Express] 请求体大小限制:', BODY_LIMIT === false ? 'unlimited' : BODY_LIMIT_RAW);
